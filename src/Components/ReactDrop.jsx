...
// import { uploadProfileImage } from "../appwrite/appwrite";
  ...
  return (
    <div className="relative h-screen w-screen flex justify-center items-center">
      ...
      <div className="relative z-10 upload-container bg-white p-6 border border-black rounded-lg shadow-lg w-1/2 h-1/2 flex flex-col justify-center items-center">
        ...
        >
          <input {...getInputProps()} />
          <p>Drag & drop your profile picture here, or click to select a file</p>
        </div>
        ...
        {uploadError && <p className="error-text text-red-500">{uploadError}</p>}
      </div>
    </div>
  );
}
